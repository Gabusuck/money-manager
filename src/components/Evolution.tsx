...
export const Evolution: React.FC<EvolutionProps> = ({ 
  ...
  return (
    <div className="px-4 pb-6 space-y-6">
      ...
      <div className="glass-panel rounded-3xl p-5 mt-2 space-y-4 shadow-premium border border-slate-200/50">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className="text-slate-800">{formatEuro(spentFixos)} / {formatEuro(effectiveSalary)} ({pctFixos.toFixed(0)}%)</span>
            </div>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className="text-slate-800">{formatEuro(savedPoupanca)} / {formatEuro(effectiveSalary)} ({pctPoupanca.toFixed(0)}%)</span>
            </div>
            <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden border border-slate-200/50">
              <div 
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className="text-slate-800">{formatEuro(investedInvestimento)} / {formatEuro(effectiveSalary)} ({pctInvestimento.toFixed(0)}%)</span>
            </div>
            <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden border border-slate-200/50">
              <div 
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className={`font-semibold ${remainingPlafondReal < 0 ? 'text-cat-red' : 'text-slate-800'}`}>
        ...
        {remainingPlafondReal < 0 && (
          <div className="flex items-center gap-2.5 p-3.5 bg-red-50 border border-red-200/50 rounded-2xl text-xxs text-cat-red font-bold">
      ...
      <div className="glass-panel rounded-3xl p-5 space-y-4 shadow-premium border border-slate-200/50">
      ...
      {investmentBanks.map(bank => {
        ...
        return (
          <div key={bank.id} className="glass-panel rounded-3xl p-5 space-y-4 shadow-premium animate-in fade-in duration-300 border border-slate-200/50">
            <div className="flex justify-between items-end">
              <div>
              ...
              <div className="text-right">
                ...
                <p className="text-[8px] font-bold text-slate-450 uppercase tracking-wider mt-1.5">últimos 30 dias</p>
              </div>
            </div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailyHistory} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                  ...
                  <Tooltip 
                    ...
                    contentStyle={{ borderRadius: '16px', border: '1px solid #e2e8f0', backgroundColor: '#ffffff', padding: '6px 10px' }}
                  />
                  <Area 
                    type="monotone" 
                    dataKey="Saldo" 
      ...
      <div className="glass-panel rounded-3xl p-5 space-y-4 shadow-premium animate-in fade-in duration-300 border border-slate-200/50">
        <div>
          ...
          <p className="text-xxs text-slate-500 mt-0.5 font-medium">Dinheiro acumulado/gasto nas contas do dia a dia (excluindo Trading/Ações)</p>
        </div>
      ...
      <div className="glass-panel rounded-3xl p-5 space-y-4 shadow-premium border border-slate-200/50">
        <div>
          ...
          <p className="text-xxs text-slate-500 mt-0.5 font-medium">Distribuição mensal dos teus recursos</p>
        </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={historyData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
              ...
              <Legend 
                ...
                iconType="circle"
                iconSize={8}
                wrapperStyle={{ fontSize: 9, fontWeight: 700, paddingTop: 10, color: '#475569' }}
              />
      ...
      <div className="glass-panel rounded-3xl p-5 shadow-premium space-y-3.5 border border-slate-200/50">
        <h4 className="text-xs font-black text-slate-800 flex items-center gap-1.5">
          <BarChart2 className="w-4.5 h-4.5 text-brand-purple" /> Observações do Mês
        </h4>
        <ul className="text-xxs text-slate-500 space-y-2 list-disc pl-4 leading-relaxed font-bold">
